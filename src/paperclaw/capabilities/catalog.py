...
def default_capability_catalog() -> CapabilityCatalog:
    ...
    capabilities = (
        ...
        _cap(
            ...
            dependencies="agent.react_runtime",
            limitations="Coordinator scheduling remains in-process.",
        ),
        _cap(
        ...
        _cap(
            ...
            limitations="Project-scoped connector activation is deferred to v0.36.",
        ),
        _cap(
            ...
            limitations="Semantic recall and reranking are separate capabilities.",
        ),
        _cap(
            "model.policy",
            "v0.10",
        ...
        _cap(
            "verification.semantic_acceptance",
            "v0.22",
            "foundation",
            ("library", "cli", "service"),
        ...
        _cap(
            ...
            limitations="Current backend is SQLite; no Redis, Kafka or NATS claim.",
        ),
        _cap(
        ...
        _cap(
            ...
            "foundation",
            ("library", "cli", "desktop"),
            "Project-scoped knowledge indexing with fingerprint freshness policy.",
            dependencies=("project.workspace", "retrieval.local_bm25"),
        ),
        _cap(
            ...
            "foundation",
            ("library", "cli"),
            "Backend-neutral weighted RRF fusion preserving citation identity.",
            dependencies="retrieval.local_bm25",
            limitations="No hosted vector backend or reranker is bundled yet.",
        ),
        _cap(
            "artifact.revisions",
            "v0.29",
            "foundation",
            ("library", "cli", "desktop", "service"),
            "Append-only artifact revisions with content-addressed verified blobs.",
            limitations="No public sharing, collaboration or blob GC yet.",
        ),
        _cap(
            "desktop.product_management",
            "v0.30",
            "experimental",
            "desktop",
            "Project, capability and artifact projection through an allowlisted API.",
            dependencies=(
                "artifact.revisions",
                "product.capability_catalog",
                "project.knowledge_runtime",
        ...
        _cap(
            ...
            "foundation",
            ("library", "cli"),
            "Message Bus requests drive Coordinator/Worker/Reviewer execution with retry and DLQ.",
        ...
        _cap(
            ...
            limitations="Failure injection, cancellation and Outbox hardening are v0.33 scope.",
        ),
    )
