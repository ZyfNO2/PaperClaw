...
class BashTool:
    ...
    def execute(self, arguments: dict[str, Any], context: ToolContext) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(False, output or "command timed out", "timeout", {"timed_out": True, "duration_ms": duration, "truncated": truncated_flag, "cleanup_failed": cleanup_failed})
        duration = int((time.perf_counter() - started) * 1000)
        ...
        return ToolResult(
            ...
            {"exit_code": process.returncode, "timed_out": False, "duration_ms": duration, "truncated": truncated_flag},
        )
