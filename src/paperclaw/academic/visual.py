...
class ColQwen2Encoder:
    ...
    def _load(self):
        ...
        try:
            ...
            raise RuntimeError("install paperclaw[academic-visual] for ColQwen") from exc
...
def late_interaction_score(query: list[list[float]], document: list[list[float]]) -> float:
