(() => {
  ...
  const messages = {
    en: {
      ...
      "state.retry": "RETRY",
      "state.error.title": "This page failed to render",
      "state.error.desc": "An unexpected mock-layer error occurred.",
    ...
    "zh-CN": {
      ...
      "state.retry": "重试",
      "state.error.title": "页面渲染失败",
      "state.error.desc": "Mock 层出现未预期错误。",
