...
安全限制、大 Trace 展示边界及 Live Replay 源库不变性。OpenCode 真实模型、
HTTPS loopback collector、无工具/`file_write`/PowerShell Live Replay 已通过；
Mistral-specific 行为与第三方 production collector 仍需独立验收。
